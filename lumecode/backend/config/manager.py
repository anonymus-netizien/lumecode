...
class ConfigManager:
    ...
    def get(
        self, key: str, default: Any = None, scope: Optional[Union[ConfigScope, str]] = None
    ) -> Any:
    ...
    def set(
        self, key: str, value: Any, scope: Union[ConfigScope, str] = ConfigScope.SESSION
    ) -> bool:
    ...
    def _save_scope(self, scope: str) -> bool:
        ...
        if scope == ConfigScope.SYSTEM.value:
            return self._save_config_file(
                self._get_system_config_path(), self._config[ConfigScope.SYSTEM.value]
            )
        elif scope == ConfigScope.USER.value:
            return self._save_config_file(
                self._get_user_config_path(), self._config[ConfigScope.USER.value]
            )
            ...
            if not self.project_dir:
                ...
                return False
            return self._save_config_file(
                self._get_project_config_path(), self._config[ConfigScope.PROJECT.value]
            )
    ...
    def get_default_config(
        self, scope: Union[ConfigScope, str] = ConfigScope.USER
    ) -> Dict[str, Any]:
        ...
        if scope_value == ConfigScope.SYSTEM.value:
            return {
                ...
                "updates": {"check_automatically": True, "check_interval_days": 1},
            }
            ...
            return {
                ...
                "agents": {
                    "code_review": {"enabled": True, "severity_threshold": "info"},
                    "refactoring": {"enabled": True, "auto_apply": False},
                },
                "plugins": {"enabled": True, "auto_update": True},
            ...
            return {
                ...
                "agents": {
                    "code_review": {"enabled": True, "rules": ["all"]},
                    "refactoring": {"enabled": True, "patterns": ["all"]},
                },
                "plugins": {"enabled": ["all"]},
            }
