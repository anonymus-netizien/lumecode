...
from backend.agents.communication import Message, MessageType, MessagePriority, MessageBus
...
class TestProcessingContext:
    ...
    def test_init(self):
        ...
        context = ProcessingContext(
            agent_id="test-agent", result_id="test-result", timestamp=123456789.0
        )
...
class TestResultProcessor:
    ...
    async def test_process_result_sequential(self, standalone_processor):
        ...
        context = ProcessingContext(
            agent_id="test-agent", result_id="test-result", timestamp=time.time()
        )
    ...
    async def test_aggregator_integration(self, result_processor):
        ...
        result = {"file": "test.py", "line": 10, "message": "Test issue", "priority": "medium"}
