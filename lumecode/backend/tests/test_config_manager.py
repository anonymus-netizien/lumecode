...
class TestConfigManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config_manager = ConfigManager(base_dir=self.base_dir, project_dir=self.project_dir)
    ...
    def test_validate_config(self):
        ...
        # Valid config
        valid_config = {"name": "test", "age": 30, "settings": {"enabled": True, "value": 42}}

        errors = self.config_manager.validate_config(valid_config, schema)
        self.assertEqual(errors, [])

        # Invalid config (missing required field)
        invalid_config1 = {"age": 30, "settings": {"enabled": True}}
        ...
        invalid_config2 = {"name": "test", "age": "thirty", "settings": {"enabled": True}}
        ...
        invalid_config3 = {"name": "test", "settings": {"enabled": "yes"}}
