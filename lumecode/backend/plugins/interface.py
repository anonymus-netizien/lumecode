...
class AnalyzerPlugin(PluginInterface):
    ...
    @abc.abstractmethod
    def analyze_file(self, file_path: Union[str, Path], options: Optional[Dict[str, Any]] = None) -> PluginResult:
    ...
    @abc.abstractmethod
    def analyze_code(self, code: str, language: str, options: Optional[Dict[str, Any]] = None) -> PluginResult:
    ...
    def analyze_project(self, project_path: Union[str, Path], options: Optional[Dict[str, Any]] = None) -> PluginResult:
...
class TransformerPlugin(PluginInterface):
    ...
    @abc.abstractmethod
    def transform_file(self, file_path: Union[str, Path], options: Optional[Dict[str, Any]] = None) -> PluginResult:
    ...
    @abc.abstractmethod
    def transform_code(self, code: str, language: str, options: Optional[Dict[str, Any]] = None) -> PluginResult:
    ...
    def preview_transformation(self, code: str, language: str, options: Optional[Dict[str, Any]] = None) -> PluginResult:
...
class GeneratorPlugin(PluginInterface):
    ...
    @abc.abstractmethod
    def generate_code(self, specification: Dict[str, Any], language: str, options: Optional[Dict[str, Any]] = None) -> PluginResult:
    ...
    def generate_from_template(self, template_name: str, context: Dict[str, Any], options: Optional[Dict[str, Any]] = None) -> PluginResult:
...
class PluginManager:
    ...
    def execute_plugin(self, plugin_id: str, context: Dict[str, Any]) -> PluginResult:
        ...
        if plugin.status != PluginStatus.INITIALIZED and plugin.status != PluginStatus.ACTIVE:
            return PluginResult.error_result(f"Plugin not ready: {plugin_id} (status: {plugin.status.value})")
