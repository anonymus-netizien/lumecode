...
class PluginManager:
    ...
    def discover_plugins(self) -> List[str]:
        ...
        for item in os.listdir(self.plugin_dir):
            if os.path.isdir(os.path.join(self.plugin_dir, item)) and \
               os.path.exists(os.path.join(self.plugin_dir, item, "__init__.py")):
    ...
    async def execute_plugin(self, plugin_name: str, context: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """
